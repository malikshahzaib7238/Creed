...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!leftArrow || !rightArrow || !mainImageElement || !titleImageElement || !subtitleElement) {
        console.error("A slider element could not be found. Please check your HTML class names.");
        return;
    }
